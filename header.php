...
<nav class="navbar navbar-expand-md navbar-light fixed-top">
		...
		<strong><em>Resurv: Order and Restaurant Reservations</em></strong>
            </a>
			...
			<li><a class="nav-link fa fa-sign-in" data-toggle="modal" data-target="#myModal_reg" onclick>&nbsp;Sign Up</a></li>
